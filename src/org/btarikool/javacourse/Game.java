...
public class Game {
      ...
      public static void main(String[]args) {
          static void createKindomAndPrepare Kingdom farAway = createKindomAndPrepare("Far Away Kingdom");
          Kingdom
    ...
    private static Kingdom createKindomAndPrepare(String far_away_kingdom) {
    }
