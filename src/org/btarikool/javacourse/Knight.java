...
public class Knight extends Human {
    ...
    public Knight(String name, String title, double healPoints, int authorityPoints, int statusLevel, int collectiveListId, int ownListId, Kingdom kingdom, Human chief) {
